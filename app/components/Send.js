                ...
                <div className="col-xs-12">
                  <table>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="btn-sm">
                          aw12e3r4t5y6ui8o94r5t6y7u8i6g7h
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="btn-sm">
                          a1w4f53sd4f5g6h7j8ia2s3d4f5g6h7
                        </div>
                      </td>
                      <td>
                        <div className="btn-sm right delete">
        ...
        >
          Confirm Transaction
            ...
            <div className="send-notice">
              <p>
                All NEO and GAS transactions are free. Only send NEO and GAS to
                a valid NEO address. Sending to an address other than a NEO
                address can result in your NEO/GAS being lost. You cannot send a
                fraction of a NEO.
              </p>
            </div>
          </div>
